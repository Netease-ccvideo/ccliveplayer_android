...
#include "ijk4a/IMediaDataSource.h"
...
//    ALOGI("IJKMEDIA-RDS ijkmds_read size(%d) logical_size(%lld)", size, c->logical_pos);
...
//    ALOGI("IJKMEDIA-RDS ijkmds_seek whence(%d) pos(%lld) logical_size(%lld)", whence, pos, c->logical_pos);
