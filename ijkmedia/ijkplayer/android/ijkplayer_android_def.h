...
enum media_event_type {
    ...
    MEDIA_CAPTURE_COMPLETE = 300,       //arg1 = width, arg2 = height, obj = argb data
    MEDIA_FIRST_BUFFERING_COMPLETE = 301, //first buffering complete
...
enum media_info_type {
	...
	// poor smooth warn
	MEDIA_INFO_BUFFERING_COUNT_WARN = 704,
    ...
    //20xx
    MEDIA_INFO_RESTORE_VIDEO_PLAY = 2000,
	
	MEDIA_INFO_REDRAW = 2001
};
