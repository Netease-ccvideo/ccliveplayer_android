...
typedef struct SDL_AMediaCodecBufferInfo {
    ...
    uint32_t flags;
    uint8_t* bufferptr;
    uint8_t* buffer_change_format_ptr;
...
typedef struct SDL_AMediaCodec
{
    ...
    ssize_t                 (*func_dequeueOutputBuffer)(SDL_AMediaCodec* acodec, SDL_AMediaCodecBufferInfo *info, int64_t timeoutUs, int rawenable);
...
ssize_t                 SDL_AMediaCodec_dequeueOutputBuffer(SDL_AMediaCodec* acodec, SDL_AMediaCodecBufferInfo *info, int64_t timeoutUs, int rawenable);
