...
SDL_Vout *SDL_VoutAndroid_CreateForAndroidSurface(void *mp, bool(*post_redraw_msg)(void*), bool(*OnRawImageAvailable)(void *arg, unsigned char**, int*, int, int, int, int), int nPanorama)
{
    return SDL_VoutAndroid_CreateForANativeWindow(mp, post_redraw_msg, OnRawImageAvailable, nPanorama);
}
